...
public class DataModifier {
    ...
    public ModifiedData modifyData(DataSnapshot dataSnapshot) {
    ...
    private ArrayList<TransactionModel> getTransactions(DataSnapshot dataSnapshot) {
    ...
    private void sortTransactions(ArrayList<TransactionModel> transactions) {
    ...
    private Map<String, String> calculateExpenseIncomeBalance(ArrayList<TransactionModel> transactions) {
    ...
    private void modifyTransactionAmounts(ArrayList<TransactionModel> transactions) {
        for (TransactionModel model : transactions) {
            String type = model.getType();
            double amount = Double.parseDouble(model.getAmount());
            if (type.equals("expense")) {
