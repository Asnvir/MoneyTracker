...
public class EditTransactionFragment extends Fragment implements HasCustomTitle {
    ...
    private void observeViewModel() {
        ...
        viewModel.getNote().observe(getViewLifecycleOwner(), note -> binding.eddTransactionTXTNote.setText(note));
